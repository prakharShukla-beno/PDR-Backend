...
import contactRoutes       from "../modules/contacts/contact.routes.js";           // ← NEW
import contactImportRoutes from "../modules/import/contactImport.routes.js";      // ← NEW
...
router.use("/import/contacts",  contactImportRoutes);   // ← NEW — contact import
...
router.use("/contacts",         contactRoutes);          // ← NEW — contact CRUD
