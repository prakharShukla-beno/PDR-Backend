...
const contactValidation = [
  // accountId optional — Apollo style
  body("accountId").optional().isMongoId().withMessage("Invalid accountId"),
  body("email").optional().isEmail().withMessage("Invalid email format"),
  body("secondaryEmail").optional().isEmail().withMessage("Invalid secondary email"),
  body("functionalDomain").optional().isIn(FUNCTIONAL_DOMAINS).withMessage("Invalid functional domain"),
];
